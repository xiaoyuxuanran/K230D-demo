...
|---|---|
| 主控 | K230D (CanMV K230) |
| 固件 | `CanMV_K230D_Lushanpi_Lite_micropython_v1.6-50` |
| 屏幕 | ST7701 3.1寸 LCD，800×480，触摸 |
| 摄像头 | CSI-2 (sensor_id=2) |
| 蜂鸣器 | GPIO61, PWM1, 4000Hz |
| 功放 | GPIO10, 高电平使能 |
| 触摸 | I2C TOUCH(0)，最多 5 点 |
